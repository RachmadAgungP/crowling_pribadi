...
tgl = "December 13, 2020"
# df = pd.read_csv("data_namapekerjaan1.csv")
df = pd.read_csv("Disnaker/appium/Debug/Data_debug/%s/data_saat_Debug.csv"%tgl)
print (df.columns)
...
DF_fix.to_csv('hasil\%s\data_Fix.csv'%tgl, mode = 'a', header = False)
